...
@pytest.mark.parametrize("action_0,action_1", permutations(list(range(6)), 2))
def test_multiagent_turtle(basic_env_config, action_0, action_1):
    ...
    validate_turtle_actions(
        actions, init_positions, rep._positions, init_map, rep.rep._map
    )


@pytest.mark.parametrize("action_0,action_1", permutations(list(range(2)), 2))
