...
class SMBProblem(Problem):
    ...
    def init_graphics(self):
        self._graphics = {
            "empty": Image.open(os.path.dirname(__file__) + "/smb/empty.png").convert(
                "RGBA"
            ),
            "solid": Image.open(
            ...
            "enemy": Image.open(os.path.dirname(__file__) + "/smb/enemy.png").convert(
                "RGBA"
            ),
            "brick": Image.open(os.path.dirname(__file__) + "/smb/brick.png").convert(
                "RGBA"
            ),
            "question": Image.open(
            ...
            "flag": Image.open(os.path.dirname(__file__) + "/smb/flagside.png").convert(
                "RGBA"
            ),
            "player": Image.open(os.path.dirname(__file__) + "/smb/player.png").convert(
                "RGBA"
            ),
        }
