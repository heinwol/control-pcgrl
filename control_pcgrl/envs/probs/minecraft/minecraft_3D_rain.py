...
class Minecraft3Drain(Problem3D):
    ...
    def __init__(self, cfg: Config):
        ...
        self.cond_bounds = {
            ...
            "floating_blocks": (
                0,
                np.floor(self._width * self._length * self._height / 2),
            ),
            ...
            "hanging_blocks": (
                0,
                np.floor(self._width * self._length / 2 * self._height),
            ),
        }
    ...
    def get_stats(self, map):
        ...
        # start_time = timer()
        self.path_length, self.ordered_path, self.n_jump = calc_longest_path(
    ...
    def render_path_change(
        self, map, path_coords, old_path_coords, ordered_path=None, **kwargs
    ):
        ...
        path_to_render = set(
            [
                ...
                if map[coords[2]][coords[1]][coords[0]] == "AIR"
            ]
        )
